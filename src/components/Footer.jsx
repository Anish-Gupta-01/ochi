...
function Footer() {
  return (
    <div className='flex justify-around p-10 w-full h-screen 
        font-["Founders_Grotesk, Roboto, sans-serif"] overflow-hidden'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
            <div>
                <h1 className='text-[7vw] font-semibold uppercase -mb-16 
                tracking-extra-tight'>eye-</h1>
                <h1 className='text-[7vw] font-semibold uppercase -mb-16 tracking-extra-tight'>opening</h1>
            </div>
        ...
        <div className='w-1/2'>
            <h1 className='text-[7vw] tracking-extra-tight font-semibold uppercase font-["NeueMontreal, Roboto, sans-serif"] -ml-10'>presentations</h1>
            <div className='flex w-full'>
                <div className='w-2/3'>
                    {["S:"].map((item, index) => (
                        <a key={index} className='block text-xl -ml-8 mb-5 mt-10'>{item}</a>
                    ))}
                    {["Instagram", "Facebok", "Linkedin"].map((item, index) => (
                        <a key={index} className='block text-xl -ml-8 p-1 leading-none'>{item}</a>
                    ))}
                    {["E:", "ochi@gmail.com"].map((item, index) => (
                        <a key={index} className='block text-xl -ml-8 mt-10 leading-none'>{item}</a>
                    ))}
                </div>
                <div className='w-1/4'>
                    {["M:"].map((item, index) => (
                    ...
                    {["Home", "Service", "Our Work", "About us", "Insights", "Contact us"].map((item, index) => (
                        <a key={index} className='block text-xl -ml-8 p-1 leading-none'>{item}</a>
                    ))}
                </div>
            </div>
